...
class MensagensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mensagem" do
    assert_difference('Mensagem.count') do
      post mensagens_url, params: { mensagem: { autor: @mensagem.autor, corpo: @mensagem.corpo, titulo: @mensagem.titulo } }
    end
  ...
  test "should update mensagem" do
    patch mensagem_url(@mensagem), params: { mensagem: { autor: @mensagem.autor, corpo: @mensagem.corpo, titulo: @mensagem.titulo } }
